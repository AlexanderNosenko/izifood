...
;( function( window ) {
	...
	SelectFx.prototype._init = function() {
		...
		// placeholder elem
		this.selectedOpt.image = this.selectedOpt.getAttribute('data-image');
	...
	SelectFx.prototype._createSelectEl = function() {
		var self = this, options = '', createOptionHTML = function(el) {
			var optclass = '', classes = '', link = '', image = '';
	...
	SelectFx.prototype._toggleSelect = function() {
		...
		if( this._isOpen() ) {
			if( this.current !== -1 ) {
				...
				var text = '<img src="' + jQuery(this.selOpts[ this.current ]).find('img').prop('src') + '"/>';
				text += '<span>' + this.selOpts[ this.current ].textContent + '</span>';
				this.selPlaceholder.innerHTML = text;
			}
